        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                <div class="p-8">
                    ...
                    <form action="{{ route('student.update') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="sname" name="sname" type="text" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all duration-200" value="{{ $data->name }}" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="roll_number" name="roll_number" type="text" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all duration-200" value="{{ $data->roll_number }}" required />
